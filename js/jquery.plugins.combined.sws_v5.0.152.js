...
/**
 * Mustache jQuery plugin for faster templating.
 *
 * Doesn't return jQuery object ("$(<html>)", since that function is a bit unstable between browsers, see http://api.jquery.com/jQuery/#jQuery2.
 */
(function ($) {
   $.fn.mustache = function (data, partials) {
      return Mustache.render(this.html(), data, partials);
    };
})(jQuery);
